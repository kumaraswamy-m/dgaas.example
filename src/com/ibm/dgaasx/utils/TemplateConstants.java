...
{
	private static final List<String> ALLOWED_ELEMENT_OPERATION = new ArrayList<String>();
	...
	private static final List<String> ALLOWED_LOCATION = new ArrayList<String>();
	...
	public static boolean isAllowedElementOperation(String operation)
	{
		return ALLOWED_ELEMENT_OPERATION.contains(operation);
	}
	public static boolean isAllowedLocation( String location)
	{
		return ALLOWED_LOCATION.contains( location);
	}
	static
	{
	...
	public static final String ATTRIBUTE_CONTEXT = "attribute context"; //$NON-NLS-1$

	public static final String NATIVE_FILTER = "native filter"; //$NON-NLS-1$
	public static final String SCRIPTED_FILTER = "scripted filter"; //$NON-NLS-1$
	public static final String NATIVE_SORT = "native sort"; //$NON-NLS-1$
	public static final String SCRIPTED_SORT = "scripted sort"; //$NON-NLS-1$
	public static final String QUERY_LIMIT = "query limit"; //$NON-NLS-1$
